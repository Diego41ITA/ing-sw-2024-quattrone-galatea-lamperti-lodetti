...
/**
 * Implementation of CheckInterface that checks for diagonal placement of cards with mushroom type
 * It checks if there are three cards with mushroom type placed diagonally
 * @author Luca Lamperti
 */
public class DiagonalMushroomCheck implements CheckInterface {
    /**
     * Checks if the requirements for diagonal placement of mushroom cards are satisfied
     *
